...
*/
    ...
    //中文
    // const traffic_category = ['风景名胜', '住宿服务', '商务住宅', '金融保险服务', '公司企业', '交通设施服务', '科教文化服务', '购物服务', '生活服务', '餐饮服务', '体育休闲服务', '医疗保健服务'];
  //英文缩写
    //const traffic_category = ['scenery', 'Accommodation', 'residence', 'finance', 'corporation', 'transport', 'education', 'mall', 'life', 'food', 'sport', 'hospital'];
    const traffic_category = ['Sce.', 'Acc.', 'Res.', 'Fin.', 'Cor.', 'Tra.', 'Edu.', 'Mall', 'Life', 'Food', 'Sport', 'Hos.'];

    Category.prototype.getLegend = function (options) {
        var splitList = this.splitList;
        var container = document.createElement('div');
        container.style.cssText = "background:#fff; padding: 2px; border: 1px solid #ccc;";
        var html = '';
        for (var key in splitList) {
            html += '<div style="line-height: 12px;" value="' + key + '">' +
              '<span style="vertical-align: 1px; display: inline-block; width: 12px; height: 7px;background:' + splitList[key] + ';"></span>' +
              '<span style="margin-left: 3px; font-size: 1px;">' + traffic_category[key] + '<span>' +
              '</div>';
        }
